...
-- Handles
	...
	Wingman = 0,	--wingman
	Recycler = 0,	--recycler
	CerbAttacker1 = 0,	--Cerb Siren (cutscene)
	CerbAttacker2 = 0,	--Cerb scout (cutscene)
	HadeanScout1 = 0,	--Hadean scout (cutscene)
	HadeanScout2 = 0, --Hadean scout (cutscene)
	Player = 0, --Player
	CerbRelay = 0,	--cerb relay
	InterferenceNav = 0,	--"Source" nav
-- Ints
	TPS = 10,
	MissionState = 0,
	WindexNagState = 0,
