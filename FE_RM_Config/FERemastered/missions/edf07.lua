----------------------------------------------------------------
-- FE edf07.lua Mission - Version 1.0
-- Date Modified: 11/01/2021
-- Summary: Mission script for the EDF07 Forgotten Enemies Mission.
----------------------------------------------------------------
...
function Load(...)
	...
	-- Special note: Terrain resets on load, so after everything is loaded, re-stamp terrain if the mission was past that point.
	if M.Routine14State >= 34 then
		EDF07NukeTerrain();
	end
end
